 ...
 * Replace CLOUD_NAME and UPLOAD_PRESET in `js/constants/constants.js` (CLOUDINARY_CONFIG) with your Cloudinary project values.
 * @module cloudinary-service
 */

import { CLOUDINARY_CONFIG } from '../constants/constants.js';
